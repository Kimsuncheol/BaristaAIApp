                ...
                HStack {
                    ...
                    .onTapGesture {
                        if let email = user?.email {
                            let newCartItem = Cart(id: UUID().uuidString, customerEmail: email, drink_id: myfavorite.id, name: myfavorite.name, price: myfavorite.price, quantity: count, selected: true)
